...
msg=$(curl -sS -H "Accept: application/json" -H "Content-Type: application/json" -X POST -d '[{"eventId":"oldpro","variantId":"whoa"}]' localhost:3000/events/ | jq -r 'fromjson | .[].message')
